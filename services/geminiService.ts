...
export const extractLabData = async (text: string, images?: string[]): Promise<LabResults> => {
...
${hasImages ? `Analyze the provided ${images.length} image(s) of medical reports.` : "Analyze the unstructured text provided below."}
